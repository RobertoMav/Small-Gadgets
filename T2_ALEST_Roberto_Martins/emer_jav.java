...
class Paciente {
    ...
    public void setTempoTriagem(int tempo_triagem) {
        this.tempo_triagem = tempo_triagem;
    }
    ...
    public void setTempoAtendimento(int tempo_atendimento) {
...
class Emergencia {
    ...
    public void calcularResultados() {
        ...
        for (String risco : tempo_medio_espera_filas.keySet()) {
            double tempo_medio = tempo_medio_espera_filas.get(risco);
            System.out.println(risco + ": " + tempo_medio);
        }
